...
public class MainWindow extends JPanel implements MouseListener, ActionListener
{
	...
	private JMenuItem callFive, callTen, releaseFive, releaseTen, releaseAll;
	 ...
	 */
	public MainWindow(JFrame parentFrame, Game g)
	{
	 ...
	 */
	public static void createAndShowGUI(Game g)
	{
		try
		{
		...
		JFrame frame = new JFrame("CloneAnt");
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

		// Create and set up the content pane.
		JComponent newContentPane = new MainWindow(frame, g);
