/** Joseph Lewis
 *
 * I've also tried Matt's version of this, works no better.
 *
 **/
// includes
#include "hmc6352.h"
...
unsigned int hmc6352_get_heading_degrees(i2c_p& i2c)
{
	...
	debug("i2c read heading, do read\n");
	wait_time(HMC6352_TIME_DELAY_MS * TICKS_PER_MS, tmr);
	// Do the read
	i2c_start( i2c );
	i2c_write( i2c, HMC6352_ID_READ );
